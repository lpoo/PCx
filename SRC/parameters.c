...
NewParameters()
{
   ...
   ptr->InputDirectory = NULL;	/* there's not particular place to look for the MPS input files */
   ptr->OutputDirectory = NULL;	/* there's not particular place write the output */
   ptr->WriteSolution  = YES;	/* yes, write the solution to the file probname.out */
   ptr->WriteHistory   = YES;	/* yes, don't write any history info to the file probname.log */
     ...
     char           *sinfile;
{
   ...
   static char    *KeyWord[] = {"max", "min", "solution",
				...
				"preprocess", "inputdirectory", "outputdirectory", "opttol",
	 ...
	 switch (match)
	    ...
	    case 10:			/* input directory */
	       if (second != NULL)
		  {
	       ...
	       break;
	    case 11:			/* output directory */
	       if (second != NULL)
		  {
		     parameters->OutputDirectory = StrDup(second,
							 "InputDirectory");
	    ...
	    case 22:    /* Gondzio higher-order corrections */
	       ...
	       else
		  {
	       ...
	       break;
	    case 23:    /* Gondzio higher-order corrections */
	       if (second == NULL)
		  {
