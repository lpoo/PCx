...
extern int      Eta, Etamax, aumenta,marca,marcatroca,marcares;
      ...
      int corretor, teste;
{
   ...
   if(corretor && MIX) 
   {
     ...
     if(stat*6>= A->m) //|| marca==1) 
       if (Eta < 20) //aumenta < 3 && (stat*6 >= A->m &&)
       {
         Eta=Eta+10;             
         aumenta++;
         printf("Aumenta = %d \n",aumenta);
         ...
         
       {
          ...
          fprintf(eigout,"Parametros da troca IGC*6>A->m e Eta < 20 \n");			
          MIX= FALSE; 
       ...
       // ITCG >= A->m/4 ou PriInf < 10^-5 //////////////O que é PriInf?
